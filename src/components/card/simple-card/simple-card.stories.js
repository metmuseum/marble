...
const cardMarkup = (model) => {
	return html `
	<section class="js-scroll-effect component js-waypoint simple-card__wrapper productive-component  ${model.leftText  ? "left-text" : ""}">
		<div class="simple-card">
			<div class="simple-card__item-wrapper">
				<a class="simple-card__image-link gtm-homepage-simple-card-img" href="${model.link.url}" title="${model.images.alt}">
					<figure class="simple-card__image-wrapper">
						<img class="lazy simple-card__image"
			...
			<div class="simple-card__copy-wrapper">
				<div class="simple-card__copy">
					...
					<a class="button--tertiary gtm-homepage-simple-card-cta" href="${model.link.url}">${model.link.text}</a>
				</div>
			</div>
		</div>
	</section>
